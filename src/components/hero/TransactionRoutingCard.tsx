...
export default function TransactionRoutingCard() {
  return (
    <div className="rounded-2xl p-3.5 w-full flex flex-col justify-between border border-white/[0.08] shadow-[0_10px_30px_rgba(0,0,0,0.6)] relative overflow-hidden bg-[#120f1c]/90 backdrop-blur-xl h-[130px] select-none">
      {/* Sender Row */}
      <div className="flex items-center justify-between text-[12px] bg-white/[0.04] p-1.5 px-2.5 rounded-lg border border-white/5">
      ...
      <div className="flex justify-center -my-1.5 z-10">
        <div className="w-4.5 h-4.5 rounded-full bg-[#E03E99] flex items-center justify-center shadow-[0_0_8px_#E03E99]">
      ...
      <div className="flex items-center justify-between text-[12px] bg-white/[0.04] p-1.5 px-2.5 rounded-lg border border-white/5">
        ...
        <span
          className="text-[12px] font-semibold text-[#ff8ac8]"
          style={{ fontFamily: "var(--font-outfit), sans-serif" }}
        >
          $700
        </span>
